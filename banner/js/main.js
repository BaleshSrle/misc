$(document).ready(() => {
    ...
    $("script:eq(3)").on("error", function () {
        $(this).attr("src", "https://cdnjs.cloudflare.com/ajax/libs/JQuery-Snowfall/1.7.4/snowfall.jquery.min.js");
    });
    ...
    (moment().isBetween("2026-01-16", "2026-12-02")) ? $("img#hosting").attr("src", "img/docaffe.jpg") : ($("img#hosting").attr("src", "img/dobojcaffe.png"), $(document).snowfall({flakeColor: "white", minSpeed: 2, maxSpeed: 10, round: false, shadow: false }));
