...
jQuery(function ($) {
    ...
    $("div#internet.carousel").each(function () {
        ...
        $(this).find("div.carousel-item:eq(0)").wrapInner($("<a></a>").attr({ "href": "https://internetdefenseleague.org", "hreflang": "en", "target": "_blank" }).append($("<img>").attr({ "src": "images/IDL_Shield_badge.png", "alt": "Internet Defense League" }).addClass("border-0 d-block mx-auto h-auto").css({ "margin": "3px 0px", "max-width": "180px" })));
        $(this).find("div.carousel-item:eq(1)").wrapInner($("<a></a>").attr({ "href": "https://www.worldipv6launch.org/", "hreflang": "en", "target": "_blank" }).append($("<img>").attr({ "src": "images/World_IPv6_launch.png", "alt": "World IPv6 Launch" }).addClass("border-0 d-block mx-auto h-auto").css({ "margin": "3px 0px", "max-width": "180px" })));
        $(this).find("div.carousel-item:eq(2)").wrapInner($("<a></a>").attr({ "href": "https://www.ip2location.com/free/widgets", "hreflang": "en", "target": "_blank" }).append($("<img>").attr({ "src": "https://tools.ip2location.com/200x200.png", "alt": "IP2Location" }).addClass("rounded-lg border-0 d-block mx-auto h-auto").css({ "margin": "3px 0px", "max-width": "180px" })));
    });
    ...
    $("footer").each(function () {
        ...
        $("footer p:eq(3)").addClass("mb-0").text("Ovaj sajt je zaštićen pomoću zaštitnog zida koji je kreiran pomoću sajta").append($("<object></object>").attr({ "data": "https://img.shields.io/badge/IP2Location-084e8f?logoSize=auto&link=https%3A%2F%2Fip2location.com", "name": "IP2Location" }).addClass("ml-1 align-middle"));
