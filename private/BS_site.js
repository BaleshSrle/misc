...
jQuery(function ($) {
    ...
    $("div").each(function () {
        ...
        $(this).filter("#speedtest_banner").children("div.card-body").append($("<img>").attr({ "data-label1": "Speedtest by Ookla", "data-color1": "141526", "data-badgestyle": "for-the-badge", "data-logo": "speedtest", "data-logosize": "auto", "data-link": "https://speedtest.net", "data-name": "Provjerite brzinu svog Interneta" }).addClass("StaticBadge rounded-lg d-block mx-auto img-fluid"));
    });
    ...
    $("div#MediaPlayer.carousel").each(function () {
        ...
        $(this).find("div.carousel-item:eq(0)").append($("<img>").attr({ "data-label1": "Get VLC media player", "data-color1": "ff8800", "data-badgestyle": "for-the-badge", "data-logo": "vlcmediaplayer", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.videolan.org/vlc/index.sr.html", "data-urllang": "sr", "data-name": "Get VLC media player - It plays, it streams, it kills WiMPs!!" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        $(this).find("div.carousel-item:eq(1)").append($("<img>").attr({ "data-label1": "Get Winamp", "data-color1": "f93821", "data-badgestyle": "for-the-badge", "data-logo": "winamp", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://winamp.com/player", "data-urllang": "en", "data-name": "Download Winamp Player" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        $(this).find("div.carousel-item:eq(2)").append($("<img>").attr({ "data-label1": "Download Spotify", "data-color1": "1ed760", "data-badgestyle": "for-the-badge", "data-logo": "spotify", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.spotify.com/ba-bs/download/windows/", "data-urllang": "bs-BA", "data-name": "Windows Download - Spotify" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
    });
    $("div#WebBrowser.carousel").each(function () {
        ...
        $(this).find("div.carousel-item:eq(0)").append($("<img>").attr({ "data-label1": "Get Vivaldi Browser", "data-color1": "ef3939", "data-badgestyle": "for-the-badge", "data-logo": "vivaldi", "data-logocolor": "white", "data-logosize": "auto", "data-url":"https://vivaldi.com/sr/","data-urllang":"sr", "data-name": "Download Vivaldi Web Browser Today!" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        $(this).find("div.carousel-item:eq(1)").append($("<img>").attr({ "data-label1": "Download Google Chrome", "data-color1": "4285f4", "data-badgestyle": "for-the-badge", "data-logo": "googlechrome", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.google.com/chrome/", "data-name": "Download Google Chrome" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        $(this).find("div.carousel-item:eq(2)").append($("<img>").attr({ "data-label1": "Download Firefox", "data-color1": "ff7139", "data-badgestyle": "for-the-badge", "data-logo": "firefoxbrowser", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.firefox.com/sr/", "data-urllang": "sr", "data-name": "Download Firefox" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        $(this).find("div.carousel-item:eq(3)").append($("<img>").attr({ "data-label1": "Download Opera Browser", "data-color1": "ff1b2d", "data-badgestyle": "for-the-badge", "data-logo": "opera", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.opera.com/download", "data-urllang": "en", "data-name": "Download Opera Browser" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
    });
    $("div#microsoft.carousel").each(function () {
        ...
        $(this).find("div.carousel-item:eq(2)").append($("<img>").attr({ "data-label1": "Download Bing Wallpaper", "data-color1": "0f6cbd", "data-badgestyle": "for-the-badge", "data-url": "https://www.bing.com/apps/wallpaper/download", "data-name": "Bing Wallpaper" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "32px 0px"));
        $(this).find("div.carousel-item:eq(3)").append($("<img>").attr({ "data-label1": "Visual Studio Code", "data-color1": "007acc", "data-badgestyle": "for-the-badge", "data-url": "https://code.visualstudio.com/", "data-name": "Visual Studio Code" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "32px 0px"));
    });
    ...
    $("footer").each(function () {
        $("footer > div:eq(0)").addClass("d-flex justify-content-center flex-wrap mx-auto").css("max-width", "292px").append($("<div></div>").addClass("mr-1").wrapInner($("<img>").addClass("githubBadge").attr({ "data-type": "release", "data-package": "twbs/bootstrap", "data-filter": "v4.*", "data-logo": "bootstrap", "data-logocolor": "white", "data-label": "Bootstrap", "data-labelcolor": "7952b3", "data-color": "7952b3", "alt": "Bootstrap" })), $("<div></div>").wrapInner($("<img>").addClass("githubBadge").attr({ "data-type": "release", "data-package": "jquery/jquery", "data-filter": "3.*", "data-logo": "jquery", "data-logocolor": "white", "data-label": "jQuery", "data-labelcolor": "0769ad", "data-color": "0769ad", "alt": "jQuery" })), $("<div></div>").addClass("mr-1").wrapInner($("<img>").attr({ "src": "https://img.shields.io/w3c-validation/html?targetUrl=https%3A%2F%2F" + location.host + "%2F&label=W3C%20Validation", "alt": "W3C Validation - HTML" })), $("<div></div>").wrapInner($("<img>").addClass("websiteBadge").attr({ "data-url": "https://cdn.jsdelivr.net/", "data-label": "jsDelivr CDN", "data-logo": "jsdelivr", "data-logocolor": "white", "data-color": "384d3d", "alt": "jsDelivr CDN" })));
        ...
        $("footer p:eq(3)").addClass("mb-0").text("Ovaj sajt je zaštićen pomoću zaštitnog zida koji je kreiran pomoću sajta").append($("<img>").attr({ "data-label1": "IP2Location", "data-color1": "084e8f", "data-url": "https://www.ip2location.com/", "data-name": "IP2Location" }).addClass("StaticBadge ml-1 align-middle"));
