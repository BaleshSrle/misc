...
jQuery(($) => {
    ...
    $("ol.breadcrumb").each((i, e) => {
        $(e).addClass("mb-1 py-1");
        $(e).children().last().addClass("active").attr("aria-current", "page");
    });
    $("nav.navbar").each((i, e) => {
        $(e).addClass("navbar-expand-sm navbar-dark bg-primary py-sm-1");
    ...
    $("div").each((i, e) => {
        ...
        $(e).filter("#linux, #internet").parents(".card").height(228);
    ...
    $("div#microsoft.carousel").each((i, e) => {
        ...
        $(e).find("div.carousel-item:eq(3)").append($("<object></object>").attr({ "data": "https://img.shields.io/badge/Visual%20Studio%20Code-007acc?style=for-the-badge&link=https%3A%2F%2Fcode.visualstudio.com%2F", "name": "Visual Studio Code" }).addClass("rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "32px 0px"));
    });
    $("div#linux.carousel").each((i, e) => {
        ...
        $(e).find("div.carousel-item:eq(2)").wrapInner($("<a></a>").attr({ "href": "https://mxlinux.org/download-links/", "hreflang": "en", "target": "_blank" }).append($("<img>").attr({ src: "https://cdn.simpleicons.org/mxlinux?viewbox=auto", alt: "MX Linux - Download Links" }).on("error", function () { this.src = "https://mxlinux.org/wp-content/uploads/2019/01/MX-Menu-icon-pyramids.svg" }).addClass("border-0 d-block mx-auto h-auto").css({ "margin": "10px 0px", "max-width": "180px" })));
        $(e).find("div.carousel-item:eq(3)").wrapInner($("<a></a>").attr({ "href": "https://linuxmint.com/download.php", "hreflang": "en", "target": "_blank" }).append($("<img>").attr({ src: "https://cdn.simpleicons.org/linuxmint?viewbox=auto", alt: "Download Linux Mint" }).on("error", function () { this.src = "https://raw.githubusercontent.com/linuxmint/brand-logo/refs/heads/master/ring.svg" }).addClass("border-0 d-block mx-auto h-auto").css({ "margin": "0px", "max-width": "180px" })));
        $(e).find("div.carousel-item:eq(4)").wrapInner($("<a></a>").attr({ "href": "https://www.opensuse.org/", "hreflang": "en", "target": "_blank" }).append($("<img>").attr({ src: "https://cdn.simpleicons.org/opensuse?viewbox=auto", alt: "openSUSE - Linux OS. The makers' choice for sysadmins, developers and desktop users." }).on("error", function () { this.src = "https://raw.githubusercontent.com/openSUSE/artwork/master/logos/official/logo-color.svg"; this.style.margin = "35px 0px"; }).addClass("border-0 d-block mx-auto w-auto").css({ "max-height": "180px" })));
        $(e).find("div.carousel-item:eq(5)").wrapInner($("<a></a>").attr({ "href": "https://www.debian.org/distrib/", "hreflang": "en", "target": "_blank" }).append($("<img>").attr({ src: "https://cdn.simpleicons.org/debian?viewbox=auto", alt: "Download Debian" }).on("error", function () { this.src = "https://www.debian.org/logos/openlogo-nd-100.png"; this.style.margin = "30px 0px"; }).addClass("rounded-lg border-0 d-block mx-auto w-auto").css({ "max-height": "180px" })));
