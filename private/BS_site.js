...
jQuery(function ($) {
    ...
    $("div#MediaPlayer.carousel").each(function () {
        ...
        $(this).find("div.carousel-item:eq(0)").append($("<object></object>").attr({ "data-label1": "Get VLC media player", "data-color1": "ff8800", "data-badgestyle": "for-the-badge", "data-logo": "vlcmediaplayer", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.videolan.org/vlc/index.sr.html", "data-name": "Get VLC media player - It plays, it streams, it kills WiMPs!!" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        $(this).find("div.carousel-item:eq(1)").append($("<object></object>").attr({ "data-label1": "Get Winamp", "data-color1": "f93821", "data-badgestyle": "for-the-badge", "data-logo": "winamp", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://winamp.com/player", "data-name": "Download Winamp Player" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        $(this).find("div.carousel-item:eq(2)").append($("<object></object>").attr({ "data-label1": "Download Spotify", "data-color1": "1ed760", "data-badgestyle": "for-the-badge", "data-logo": "spotify", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.spotify.com/ba/download/windows/", "data-name": "Windows Download - Spotify" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
    });
    $("div#WebBrowser.carousel").each(function () {
        ...
        $(this).find("div.carousel-item:eq(0)").append($("<object></object>").attr({ "data-label1": "Get Vivaldi Browser", "data-color1": "ef3939", "data-badgestyle": "for-the-badge", "data-logo": "vivaldi", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://vivaldi.com/sr/", "data-name": "Download Vivaldi Web Browser Today!" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        ...
        $(this).find("div.carousel-item:eq(2)").append($("<object></object>").attr({ "data-label1": "Download Firefox", "data-color1": "ff7139", "data-badgestyle": "for-the-badge", "data-logo": "firefoxbrowser", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.firefox.com/sr/", "data-name": "Download Firefox" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
        $(this).find("div.carousel-item:eq(3)").append($("<object></object>").attr({ "data-label1": "Download Opera Browser", "data-color1": "ff1b2d", "data-badgestyle": "for-the-badge", "data-logo": "opera", "data-logocolor": "white", "data-logosize": "auto", "data-url": "https://www.opera.com/download", "data-name": "Download Opera Browser" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "3px 0px"));
    });
    $("div#microsoft.carousel").each(function () {
        ...
        $(this).find("div.carousel-item:eq(2)").append($("<object></object>").attr({ "data-label1": "Download Bing Wallpaper", "data-color1": "0f6cbd", "data-badgestyle": "for-the-badge", "data-url": "https://www.bing.com/apps/wallpaper/download", "data-name": "Bing Wallpaper" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "32px 0px"));
        $(this).find("div.carousel-item:eq(3)").append($("<object></object>").attr({ "data-label1": "Visual Studio Code", "data-color1": "007acc", "data-badgestyle": "for-the-badge", "data-url": "https://www.bing.com/apps/wallpaper/download", "data-name": "Visual StudioCode" }).addClass("StaticBadge rounded-lg border-0 d-block mx-auto img-fluid").css("margin", "32px 0px"));
    });
    ...
    $("footer").each(function () {
        ...
        $("footer p:eq(3)").addClass("mb-0").text("Ovaj sajt je zaštićen pomoću zaštitnog zida koji je kreiran pomoću sajta").append($("<object></object>").attr({ "data-label1": "IP2Location", "data-color1": "084e8f", "data-url": "https://www.ip2location.com/", "data-name": "IP2Location" }).addClass("StaticBadge ml-1 align-middle"));
