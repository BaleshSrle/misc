...
$(document).ready(function () {
    ...
    $("div.modal-header:lt(15):gt(8):not(:eq(1))").addClass("d-lg-none");
    ...
    $("div.modal-header:lt(10):gt(0),div.modal-header:eq(14),div.modal-header:eq(15)").addClass("py-0 pr-0");
    $("div.modal-header:gt(0):not(:lt(13):gt(8))").addClass("py-0 pr-0");
    ...
    $("div.card-body:eq(24),div.card-body:eq(25)").addClass("bg-white");
    ...
    $("h2,h6:gt(1),p.card-text:eq(2),p.card-text:eq(5),p.card-text:eq(8),p.card-text:eq(11),div.input-group:eq(4),div.input-group:eq(5)").addClass("mb-0");
