...
$(document).ready(() => {
    ...
    $("img.StreamBadge").each((i, e) => {
        ...
        switch (Platform) {
            case "Twitch":
                const streamerNames = ["Bebahan", "Shappys", "TBJZL", "Nalopia", "Berticuss", "Develique", "Loserfruit", "Aliythia", "Fasffy", "MaryyCherryy", "2bratty", "aziaa", "Crayator", "krysttl", "Decus8", "Kaztelle", "JFrostXS", "GYmedia", "Behzinga", "freyzplayz", "TaliaMar", "Sweet_Anita", "littlebunny_x", "PerriKaryal", "angryginge13", "Bunnymontv", "Lindsfry", "CHI_Kacee", "Eveuh", "Chess", "BotezLive", "DinaBelenkaya", "BasedCode", "Fortnite", "MarvelRivals", "PUBG_BATTLEGROUNDS", "Rainbow6", "Warcraft", "WorldofTanks", "PixelbyPixelStudios", "XboxOn", "QoSpades", "FerrariEsports", "FailArmy", "TheNicoleT", "Alinity", "JadetheJaguar", "firedancer", "janifest", "AuroraStarr", "xoDee", "Morgpie", "AMOURANTH", "peyzki", "sincerelyjuju", "luvstruck", "pinkwasabitv", "KaliRoses", "allieraa", "EmmaLayne", "EmmaLayneToo", "EmjayPlayss", "BuccataX", "lauralux", "ohKayBunny", "xoAeriel", "DevonJenelle", "StrawberryTabby", "MyAustinWhite", "Hannesschan", "TrishaHershberger", "PulpFictionally", "Taylor_Jevaux", "juliaburch", "RachelKay", "AshleyNocera", "Faith", "saweetheart", "SkyeBlanchette", "thewildlatina", "LaurenAlexis_x", "XTASIAEGO", "XtasiaTV", "Elina", "xCandyLashes", "kristinemaia", "Mellooow_", "GemmasTW", "LUXGRL", "Lylkae", "Linny", "LinnyNova", "NicolePeachy", "KDRkitten", "lucyya", "xXLauoaNXx", "Aryssa614", "xeniahelenaa", "di1araas", "llunaclark", "MarieMoone", "perfilraro", "mira", "OLESYALIBERMAN"/*, "Sharishaxd"*/, "Ksenia_Noche", "MistieSage"];
