...
$(document).ready(function () {
    ...
    $("head").append("<link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/flag-icons@6/css/flag-icons.min.css'>", "<script src='https://www.google.com/recaptcha/api.js'></script>", "<script src='https://widget.time.is/sr.js'></script>", "<script src='https://oap.accuweather.com/launch.js' defer></script>", "<script src='https://www.livescore.bz/api.livescore.0.1.js' api='livescore' async></script>");
