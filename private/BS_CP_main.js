...
$(document).ready(function () {
    ...
    $("table.table").each(function () {
        ...
        $(this).find("td").children("img[src*='logo']").not("[src*='logo=nodedotjs'],[src*='logo=vlcmediaplayer'],[src*='logo=epicgames']").attr("src", function (index, src) { return src + '&logoSize=auto' });
    });
