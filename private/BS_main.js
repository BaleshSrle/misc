...
$(document).ready(() => {
    export const UrlCDN = ["https://cdn.jsdelivr.net/", "https://cdnjs.cloudflare.com/"];
    const GoogleFontsUrl = ["https://fonts.googleapis.com", "https://fonts.gstatic.com"];
    export const BadgesUrl = ["https://img.shields.io/", "https://badgen.net/"];
    ...
    (location.pathname == "/private/kontrolna_tabla.html") ? $("script[src*='BS_main']").after("<script type='module' src='" + UrlCDN[0] + "gh/BaleshSrle/misc/private/BS_CP_main.min.js'>") : $("script[src*='BS_main']").after("<script type='module' src='" + UrlCDN[0] + "gh/BaleshSrle/misc/private/BS_site.min.js'>");
    /*$.getScript(UrlCDN[0] + "gh/BaleshSrle/misc/private/BS_CP_main.min.js") : $.getScript(UrlCDN[0] + "gh/BaleshSrle/misc/private/BS_site.min.js");*/
    $("head").each((i, e) => {
