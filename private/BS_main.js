...
$(document).ready(() => {
    ...
    $("head").each((i, e) => {
        ...
        $(e).append($("<link>").attr({ "rel": "dns-prefetch", "href": "https://cdn.jsdelivr.net/" }), $("<link>").attr({ "rel": "dns-prefetch", "href": "https://fonts.gstatic.com" }), $("<link>").attr({ "rel": "preconnect", "href": "https://cdn.jsdelivr.net/", "crossorigin": "anonymous" }), $("<link>").attr({ "rel": "preconnect", "href": "https://fonts.googleapis.com" }), $("<link>").attr({ "rel": "preconnect", "href": "https://fonts.gstatic.com", "crossorigin": "anonymous" }), $("<link>").attr({ "rel": "prefetch", "href": "https://img.shields.io/" }), $("<link>").attr({ "rel": "stylesheet", "href": "https://cdn.jsdelivr.net/npm/bootstrap@4/dist/css/bootstrap.min.css", "media": "all", "crossorigin": "anonymous" }).on("error", (e) => { e.target.href = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap/4.6.2/css/bootstrap.min.css" }), $("<link>").attr({ "rel": "stylesheet", "href": "https://fonts.googleapis.com/css2?family=Ubuntu:ital,wght@0,400;0,700;1,400;1,700&display=swap", "media": "all", "crossorigin": "anonymous" }), $("<link>").attr({ "rel": "stylesheet", "href": "https://cdn.jsdelivr.net/npm/bootstrap-icons@1/font/bootstrap-icons.min.css", "media": "all", "crossorigin": "anonymous" }).on("error", (e) => { e.target.href = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.13.1/font/bootstrap-icons.min.css" }), $("<link>").attr({ "rel": "icon", "href": "https://cdn.jsdelivr.net/gh/BaleshSrle/baleshsrle.github.io/logo.png" }));
    ...
    $("script[src*='bootstrap@4']").attr("crossorigin", "anonymous").on("error", (e) => { e.target.src = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap/4.6.2/js/bootstrap.bundle.min.js"; })
