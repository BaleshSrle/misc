...
$(document).ready(() => {
    ...
    $("script[src*='jquery@3']").after($("<script></script>").attr("src", Url.CDN[0] + "npm/jquery-migrate@4/dist/jquery-migrate.min.js"));
    $("script[src*='moment@2']").on("error", function () { this.src = Url.CDN[1] + "ajax/libs/moment.js/2.30.1/moment.min.js"; });
